...
"[project]/node_modules/next-themes/dist/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
module.exports = z(ee);
var t = j(__turbopack_context__.r("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)"));
...
var Q = [
    "light",
    "dark"
], D = "(prefers-color-scheme: dark)", J = ("TURBOPACK compile-time value", "undefined") == "undefined", L = t.createContext(void 0), q = {
    setTheme: (e)=>{},
    themes: []
}, B = ()=>{
    var e;
    ...
    let [a, r] = t.useState(()=>Z(o, u)), [T, y] = t.useState(()=>a === "system" ? x() : a), k = m ? Object.values(m) : d, S = t.useCallback((i)=>{
        let c = i;
        if (!c) return;
        i === "system" && n && (c = x());
        let v = m ? m[c] : c, E = s ? K(p) : null, P = document.documentElement, M = (g)=>{
            g === "class" ? (P.classList.remove(...k), v && P.classList.add(v)) : g.startsWith("data-") && (v ? P.setAttribute(g, v) : P.removeAttribute(g));
        };
    ...
    return t.createElement("script", {
        ...w,
        suppressHydrationWarning: !0,
        nonce: ("TURBOPACK compile-time truthy", 1) ? m : "TURBOPACK unreachable",
        dangerouslySetInnerHTML: {
            __html: `(${I.toString()})(${p})`
        }
    });
...
//# sourceMappingURL=node_modules_a874ef84._.js.map