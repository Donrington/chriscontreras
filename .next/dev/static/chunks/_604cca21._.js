...
function useTheme() {
    _s();
    const { theme, setTheme } = __turbopack_context__.r("[project]/node_modules/next-themes/dist/index.js [app-client] (ecmascript)").useTheme();
    const toggleTheme = ()=>{
...
_s(useTheme, "5ABGV54qnXKp6rHn7MS/8MjwRhQ=");
var _c;
...
"[project]/node_modules/next-themes/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
var Q = [
    ...
    "light",
    "dark"
], X = ({ forcedTheme: e, disableTransitionOnChange: s = !1, enableSystem: n = !0, enableColorScheme: l = !0, storageKey: o = "theme", themes: d = G, defaultTheme: u = n ? "system" : "light", attribute: h = "data-theme", value: m, children: w, nonce: p, scriptProps: C })=>{
    let [a, r] = t.useState({
        "X.useState": ()=>Z(o, u)
...
}, Y = t.memo(({ forcedTheme: e, storageKey: s, attribute: n, enableSystem: l, enableColorScheme: o, defaultTheme: d, value: u, themes: h, nonce: m, scriptProps: w })=>{
    let p = JSON.stringify([
        n,
        s,
        d,
...
//# sourceMappingURL=_604cca21._.js.map